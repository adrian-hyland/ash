	...
	namespace System
	{
		namespace Windows
		{
			...
			public:
				...
				>
				constexpr String(Ash::String::View<FROM_ENCODING> value, bool replaceInvalidCharacter = true) : Content()
				{
					convertFrom(value, replaceInvalidCharacter).throwOnError();
				}
				...
				>
				[[nodiscard]]
				constexpr Ash::Error::Value set(VALUE value, bool replaceInvalidCharacter = true)
				{
