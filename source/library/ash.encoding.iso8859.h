...
namespace Ash
{
	namespace Encoding
	{
		namespace Iso8859
		{
			namespace Part1
			{
				using Lookup = Ash::Encoding::SingleByte::Lookup<0x100, 0, nullptr>;
				using Table = Ash::Encoding::SingleByte::Table<Lookup>;
			}
			namespace WestEuropean = Part1;

			namespace Part2
			{
				constexpr Ash::Encoding::CodeUnit16 lookup[] =
				{
				...
				using Lookup = Ash::Encoding::SingleByte::Lookup<0xA1, sizeof(lookup) / sizeof(lookup[0]), lookup>;
				using Table = Ash::Encoding::SingleByte::Table<Lookup>;
			}
			...
			namespace Part9
			{
				...
				using Lookup = Ash::Encoding::SingleByte::Lookup<0xD0, sizeof(lookup) / sizeof(lookup[0]), lookup>;
				using Table = Ash::Encoding::SingleByte::Table<Lookup>;
			}
			...
			namespace Part15
			{
				...
				using Lookup = Ash::Encoding::SingleByte::Lookup<0xA4, sizeof(lookup) / sizeof(lookup[0]), lookup>;
				using Table = Ash::Encoding::SingleByte::Table<Lookup>;
			}
