			...
			namespace Utf16be
			{
				constexpr Ash::Test::Assertion character()
				{
					...
					for (Ash::Unicode::Character::Value code = 0; code < 0xD800; code++)
					{
						...
						TEST_IS_EQ(*character.at(0), (code >> 8));
						TEST_IS_EQ(*character.at(1), (code & 0xFF));
					...
					for (Ash::Unicode::Character::Value code = 0x10000; code < 0x110000; code++)
					{
						...
						TEST_IS_EQ(*character.at(0), 0xD8 + (((code - 0x10000) >> 18) & 0x03));
						TEST_IS_EQ(*character.at(1), (((code - 0x10000) >> 10) & 0xFF));
						TEST_IS_EQ(*character.at(2), 0xDC + (((code - 0x10000) >> 8) & 0x03));
						TEST_IS_EQ(*character.at(3), ((code - 0x10000) & 0xFF));
				...
				static Ash::Test::Assertion decodeNext()
				{
					...
					{
						Ash::Memory::Vector<Ash::Encoding::Utf16be::Code, 1> invalidContent;
					...
					{
						Ash::Memory::Vector<Ash::Encoding::Utf16be::Code, 3> invalidContent;
					...
					{
						Ash::Memory::Vector<Ash::Encoding::Utf16be::Code, 4> invalidContent;
