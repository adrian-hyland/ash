...
namespace Ash
{
	namespace Test
	{
		namespace Type
		{
			...
			constexpr Ash::Test::Assertion isClass()
			{
				bool isClass = false;
			...
			constexpr Ash::Test::Assertion isFloatingPoint()
			{
			...
			constexpr Ash::Test::Assertion isInteger()
			{
			...
			constexpr Ash::Test::Assertion isUnsignedInteger()
			{
			...
			constexpr Ash::Test::Assertion isNumeric()
			{
			...
			constexpr Ash::Test::Assertion isConstant()
			{
			...
			constexpr Ash::Test::Assertion isNotConstant()
			{
