		...
		namespace Integer
		{
			namespace Math
			{
				...
				static Ash::Test::Assertion greatestCommonDivisor()
				{
					...
					constexpr int8_t s8 = std::numeric_limits<int8_t>::min();
					constexpr int16_t s16 = std::numeric_limits<int16_t>::min();
					constexpr int32_t s32 = std::numeric_limits<int32_t>::min();
					constexpr int64_t s64 = std::numeric_limits<int64_t>::min();
					...
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s8,  s16), u8);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s8,  s32), u8);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s8,  s64), u8);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s16, s8),  u8);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s16, s32), u16);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s16, s64), u16);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s32, s8),  u8);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s32, s16), u16);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s32, s64), u32);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s64, s8),  u8);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s64, s16), u16);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s64, s32), u32);
					TEST_IS_EQ(Ash::Integer::greatestCommonDivisor(s8, s16, s32, s64), u8);
