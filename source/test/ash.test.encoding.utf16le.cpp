			...
			namespace Utf16le
			{
				static Ash::Test::Assertion character()
				{
					...
					for (Ash::Unicode::Character::Value code = 0; code < 0xD800; code++)
					{
						...
						TEST_IS_EQ(*character.at(1), (code >> 8));
					...
					for (Ash::Unicode::Character::Value code = 0x10000; code < 0x110000; code++)
					{
						...
						TEST_IS_EQ(*character.at(0), (((code - 0x10000) >> 10) & 0xFF));
						TEST_IS_EQ(*character.at(1), 0xD8 + (((code - 0x10000) >> 18) & 0x03));
						TEST_IS_EQ(*character.at(2), ((code - 0x10000) & 0xFF));
						TEST_IS_EQ(*character.at(3), 0xDC + (((code - 0x10000) >> 8) & 0x03));
