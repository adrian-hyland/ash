	...
	namespace Test
	{
		namespace Encoding
		{
			namespace Utf16le
			{
				...
				{
					TEST_IS_TRUE(Ash::Encoding::Utf16le::Character::isValid(0x00));
					TEST_IS_TRUE(Ash::Encoding::Utf16le::Character::isValid(Ash::Unicode::Character::maximum));
				...
				static Ash::Test::Assertion decodeNext()
				{
					...
					TEST_IS_EQ(Ash::Encoding::Utf16le::decodeNext(content, offset, character), Ash::Memory::Error::readAccessOutOfBound);
					TEST_IS_ZERO(character.getLength());
					...
					{
						TEST_IS_EQ(content.append(Ash::Encoding::Utf16le::Character(value)), Ash::Error::none);
					}
					...
					{
						TEST_IS_EQ(Ash::Encoding::Utf16le::decodeNext(content, offset, character), Ash::Error::none);
					...
					for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(0x00, 0xFF))
					{
						...
						TEST_IS_EQ(invalidContent.set(0, Ash::Encoding::Utf16le::Code(value)), Ash::Error::none);
						TEST_IS_EQ(Ash::Encoding::Utf16le::decodeNext(invalidContent, 0, character), Ash::Memory::Error::readAccessOutOfBound);
						TEST_IS_ZERO(character.getLength());
					}
					...
					for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(0xD80000, 0xDBFFFF))
					{
						...
						TEST_IS_EQ(invalidContent.set(0, Ash::Encoding::Utf16le::Code(value >> 8)), Ash::Error::none);
						TEST_IS_EQ(invalidContent.set(1, Ash::Encoding::Utf16le::Code(value >> 16)), Ash::Error::none);
						TEST_IS_EQ(invalidContent.set(2, Ash::Encoding::Utf16le::Code(value)), Ash::Error::none);
						TEST_IS_EQ(Ash::Encoding::Utf16le::decodeNext(invalidContent, 0, character), Ash::Memory::Error::readAccessOutOfBound);
						TEST_IS_ZERO(character.getLength());
					}
					...
					for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(0xD8000000, 0xDFFFFFFF))
					{
						...
						TEST_IS_EQ(invalidContent.set(0, Ash::Encoding::Utf16le::Code(value >> 16)), Ash::Error::none);
						TEST_IS_EQ(invalidContent.set(1, Ash::Encoding::Utf16le::Code(value >> 24)), Ash::Error::none);
						TEST_IS_EQ(invalidContent.set(2, Ash::Encoding::Utf16le::Code(value)), Ash::Error::none);
						TEST_IS_EQ(invalidContent.set(3, Ash::Encoding::Utf16le::Code(value >> 8)), Ash::Error::none);
						TEST_IS_EQ(Ash::Encoding::Utf16le::decodeNext(invalidContent, 0, character), Ash::Encoding::Error::invalidCodeUnit);
						TEST_IS_ZERO(character.getLength());
					}
				...
				static Ash::Test::Assertion decodePrevious()
				{
					...
					TEST_IS_EQ(Ash::Encoding::Utf16le::decodePrevious(content, offset, character), Ash::Memory::Error::readAccessOutOfBound);
					TEST_IS_ZERO(character.getLength());
					...
					while (offset > 0)
					{
						TEST_IS_EQ(Ash::Encoding::Utf16le::decodePrevious(content, offset, character), Ash::Error::none);
						TEST_IS_EQ(Ash::Unicode::Character(character), expectedCharacter);
					...
					for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(0x00, 0xFF))
					{
						...
						TEST_IS_EQ(invalidContent.set(0, Ash::Encoding::Utf16le::Code(value)), Ash::Error::none);
						TEST_IS_EQ(Ash::Encoding::Utf16le::decodePrevious(invalidContent, invalidContent.getLength(), character), Ash::Memory::Error::readAccessOutOfBound);
						TEST_IS_ZERO(character.getLength());
					}
					...
					for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(0xDC0000, 0xDFFFFF))
					{
						...
						TEST_IS_EQ(invalidContent.set(0, Ash::Encoding::Utf16le::Code(value)), Ash::Error::none);
						TEST_IS_EQ(invalidContent.set(1, Ash::Encoding::Utf16le::Code(value >> 8)), Ash::Error::none);
						TEST_IS_EQ(invalidContent.set(2, Ash::Encoding::Utf16le::Code(value >> 16)), Ash::Error::none);
						TEST_IS_EQ(Ash::Encoding::Utf16le::decodePrevious(invalidContent, invalidContent.getLength(), character), Ash::Memory::Error::readAccessOutOfBound);
						TEST_IS_ZERO(character.getLength());
					}
					...
					for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(0xD8000000, 0xDFFFFFFF))
					{
						...
						TEST_IS_EQ(invalidContent.set(2, Ash::Encoding::Utf16le::Code(value)), Ash::Error::none);
						TEST_IS_EQ(invalidContent.set(3, Ash::Encoding::Utf16le::Code(value >> 8)), Ash::Error::none);
						TEST_IS_EQ(Ash::Encoding::Utf16le::decodePrevious(invalidContent, invalidContent.getLength(), character), Ash::Encoding::Error::invalidCodeUnit);
						TEST_IS_ZERO(character.getLength());
					}
		...
		(
			testUtf16le,
			TEST_CASE(Ash::Test::Encoding::Utf16le::isValid),
			TEST_CASE(Ash::Test::Encoding::Utf16le::character),
			TEST_CASE(Ash::Test::Encoding::Utf16le::set),
