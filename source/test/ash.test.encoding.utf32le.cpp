	...
	namespace Test
	{
		namespace Encoding
		{
			namespace Utf32le
			{
				...
				{
					TEST_IS_TRUE(Ash::Encoding::Utf32le::Character::isValid(0x00));
					TEST_IS_TRUE(Ash::Encoding::Utf32le::Character::isValid(Ash::Unicode::Character::maximum));
		...
		(
			testUtf32le,
			TEST_CASE(Ash::Test::Encoding::Utf32le::isValid),
			TEST_CASE(Ash::Test::Encoding::Utf32le::character),
			TEST_CASE(Ash::Test::Encoding::Utf32le::set),
