...
namespace Ash
{
	namespace Test
	{
		namespace Geometry
		{
			...
			constexpr Ash::Test::Assertion addPoint()
			{
				using Real = REAL;
			...
			template <typename REAL>
			constexpr Ash::Test::Assertion subtractPoint()
			{
				using Real = REAL;
				using Point = Ash::Geometry::Point2D<Real>;
				using Vector = Ash::Geometry::Vector2D<Real>;
			...
			template <typename REAL>
			constexpr Ash::Test::Assertion negatePoint()
			{
				using Real = REAL;
				using Point = Ash::Geometry::Point2D<Real>;
			...
			{
				TEST_GENERIC(Ash::Test::Geometry::addPoint, REAL);

				TEST_GENERIC(Ash::Test::Geometry::subtractPoint, REAL);

				TEST_GENERIC(Ash::Test::Geometry::negatePoint, REAL);

				TEST_GENERIC(Ash::Test::Geometry::intersects, REAL);
