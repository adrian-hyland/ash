		...
		namespace Encoding
		{
			namespace Wide
			{
				...
				static Ash::Test::Assertion decodeNext()
				{
					...
					TEST_IS_EQ(Ash::Encoding::Wide::decodeNext(content, offset, character), Ash::Memory::Error::readAccessOutOfBound);
					TEST_IS_ZERO(character.getLength());
					...
					{
						TEST_IS_EQ(content.append(Ash::Encoding::Wide::Character(value)), Ash::Error::none);
					}
					...
					{
						TEST_IS_EQ(Ash::Encoding::Wide::decodeNext(content, offset, character), Ash::Error::none);
					...
					if constexpr (Ash::Encoding::Wide::maxSize == 2)
					{
						for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(0xD8000000, 0xDFFFFFFF))
						{
							...
							TEST_IS_EQ(invalidContent.set(0, Ash::Encoding::Wide::Code(value >> 16)), Ash::Error::none);
							TEST_IS_EQ(invalidContent.set(1, Ash::Encoding::Wide::Code(value)), Ash::Error::none);
							TEST_IS_EQ(Ash::Encoding::Wide::decodeNext(invalidContent, 0, character), Ash::Encoding::Error::invalidCodeUnit);
							TEST_IS_ZERO(character.getLength());
						}
					}
					else
					{
						for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(Ash::Unicode::Character::surrogateStart, Ash::Unicode::Character::surrogateEnd))
						{
							...
							TEST_IS_EQ(invalidContent.set(0, Ash::Encoding::Wide::Code(value)), Ash::Error::none);
							TEST_IS_EQ(Ash::Encoding::Wide::decodeNext(invalidContent, 0, character), Ash::Encoding::Error::invalidCodePoint);
							TEST_IS_ZERO(character.getLength());
						}
				...
				static Ash::Test::Assertion decodePrevious()
				{
					...
					TEST_IS_EQ(Ash::Encoding::Wide::decodePrevious(content, offset, character), Ash::Memory::Error::readAccessOutOfBound);
					TEST_IS_ZERO(character.getLength());
					...
					while (offset > 0)
					{
						TEST_IS_EQ(Ash::Encoding::Wide::decodePrevious(content, offset, character), Ash::Error::none);
						TEST_IS_EQ(Ash::Unicode::Character(character), expectedCharacter);
					...
					if constexpr (Ash::Encoding::Wide::maxSize == 2)
					{
						for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(0xD8000000, 0xDFFFFFFF))
						{
							...
							TEST_IS_EQ(invalidContent.set(0, Ash::Encoding::Wide::Code(value >> 16)), Ash::Error::none);
							TEST_IS_EQ(invalidContent.set(1, Ash::Encoding::Wide::Code(value)), Ash::Error::none);
							TEST_IS_EQ(Ash::Encoding::Wide::decodePrevious(invalidContent, invalidContent.getLength(), character), Ash::Encoding::Error::invalidCodeUnit);
							TEST_IS_ZERO(character.getLength());
						}
					}
					else
					{
						for (Ash::Unicode::Character::Value value : Ash::Iterate<Ash::Unicode::Character::Value>::between(Ash::Unicode::Character::surrogateStart, Ash::Unicode::Character::surrogateEnd))
						{
							...
							TEST_IS_EQ(invalidContent.set(0, Ash::Encoding::Wide::Code(value)), Ash::Error::none);
							TEST_IS_EQ(Ash::Encoding::Wide::decodePrevious(invalidContent, invalidContent.getLength(), character), Ash::Encoding::Error::invalidCodePoint);
							TEST_IS_ZERO(character.getLength());
						}
